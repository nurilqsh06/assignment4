package main.topological;

import java.util.*;

import main.common.BaseMetrics;
import main.common.Graph;
...
public class TopologicalSort extends BaseMetrics {
    ...
    public long getOperationCount() {
        throw new UnsupportedOperationException("Unimplemented method 'getOperationCount'");
    }
}
